...
= OBJECT_ID(N'[dbo].[sp_PharmacyModule_GetRecentReceipts]') AND type in (N'P', N'PC'))
...
LEFT JOIN (SELECT DISTINCT Id, DrugBatchId FROM DrugIssued) f ON a.DrugBatchId = f.DrugBatchId
