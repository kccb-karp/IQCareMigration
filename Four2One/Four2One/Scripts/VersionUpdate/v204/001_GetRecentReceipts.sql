ALTER PROC [dbo].[sp_PharmacyModule_GetRecentReceipts] 
AS
BEGIN
...
LEFT JOIN (SELECT DISTINCT DrugBatchId FROM DrugIssued WHERE DeleteFlag = 0) f ON a.DrugBatchId = f.DrugBatchId
