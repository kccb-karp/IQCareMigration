...
select d.PersonId
, d.Id PatientID
, SUBSTRING(EmergContactName,0,CHARINDEX(' ',EmergContactName,0)) FirstName
, SUBSTRING(EmergContactName,CHARINDEX(' ',EmergContactName,0), LEN(EmergContactName)) LastName
