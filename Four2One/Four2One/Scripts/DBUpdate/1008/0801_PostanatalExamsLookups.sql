...
-- LookupMasterItem
If Not Exists(Select 1 From LookupMasterItem where LookupMasterId=(SELECT TOP 1 Id FROM LookupMaster WHERE Name='Fistula Screening') 
and LookupItemId=(SELECT TOP 1 Id FROM LookupItem WHERE Name='Repaired')) 
Begin Insert Into LookupMasterItem(LookupMasterId ,LookupItemId,DisplayName, OrdRank)
VALUES((SELECT TOP 1 Id FROM LookupMaster WHERE Name='Fistula Screening')
,(SELECT TOP 1 Id FROM LookupItem WHERE Name='Repaired'),'Repaired',1);
end
...
If Not Exists(Select 1 From LookupMasterItem where LookupMasterId=(SELECT TOP 1 Id FROM LookupMaster WHERE Name='Fistula Screening') 
and LookupItemId=(SELECT TOP 1 Id FROM LookupItem WHERE Name='Infected')) 
Begin Insert Into LookupMasterItem(LookupMasterId ,LookupItemId,DisplayName, OrdRank)VALUES((SELECT TOP 1 Id FROM LookupMaster WHERE Name='Fistula Screening')
,(SELECT TOP 1 Id FROM LookupItem WHERE Name='Infected'),'Infected',3);end 
...
If Not Exists(Select 1 From LookupMasterItem where LookupMasterId=(SELECT TOP 1 Id FROM LookupMaster WHERE Name='Fistula Screening') 
and LookupItemId=(SELECT TOP 1 Id FROM LookupItem WHERE Name='N/A')) 
Begin 

Insert Into LookupMasterItem(LookupMasterId ,LookupItemId,DisplayName, OrdRank)
VALUES
((SELECT TOP 1 Id FROM LookupMaster WHERE Name='Fistula Screening')
,(SELECT TOP 1 Id FROM LookupItem WHERE Name='N/A')
,'N/A'
,5);
END
