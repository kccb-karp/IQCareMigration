...
IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='Birth Plans' AND MasterName='counselledOn')
BEGIN
...
IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='Danger Signs' AND MasterName='counselledOn')
BEGIN
...
IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='Family Planning' AND MasterName='counselledOn')
BEGIN
...
IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='HIV' AND MasterName='counselledOn')
BEGIN
...
IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='Supplemental Feeding' AND MasterName='counselledOn')
BEGIN
...
IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='Breast Care' AND MasterName='counselledOn')
BEGIN
	INSERT INTO LookupMasterItem(LookupMasterId,LookupItemId,DisplayName,OrdRank) VALUES((SELECT top 1 Id FROM LookupMaster WHERE Name='counselledOn'),(SELECT top 1 Id FROM LookupItem WHERE Name='Breast Care'),'Breast Care',6)
END

IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='Infant Feeding' AND MasterName='counselledOn')
BEGIN
...
IF NOT EXISTS(SELECT * FROM LookupItemView WHERE ItemName='Insecticide Treated Nets' AND MasterName='counselledOn')
BEGIN
