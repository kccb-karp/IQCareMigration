...
If Not Exists(Select 1 From LookupItem where Name='INH - Client was screened negative & started INH') Begin INSERT INTO LookupItem (Name, DisplayName, DeleteFlag) VALUES ('INH - Client was screened negative & started INH','INH - Client was screened negative & started INH',0); End
