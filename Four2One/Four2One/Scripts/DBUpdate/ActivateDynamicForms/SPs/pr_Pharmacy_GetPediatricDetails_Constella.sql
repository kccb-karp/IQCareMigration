...
/****** Object:  StoredProcedure [dbo].[pr_Pharmacy_GetPediatricDetails_Constella]    Script Date: 9/10/2018 10:38:10 AM ******/
SET ANSI_NULLS ON
GO
...
As                                                                                                    
Begin                                                                                                    
Declare @SymKey varchar(max)                                                                          
Set @SymKey = 'Open symmetric key Key_CTC decryption by password='+ @password + ''                                                                              
exec(@SymKey)    

Declare @Drug Table(Drug_Pk int, DrugName varchar(2500), GenericAbbreviation varchar(1000), GenericCommaSeparated varchar(1000),DrugTypeId int);
