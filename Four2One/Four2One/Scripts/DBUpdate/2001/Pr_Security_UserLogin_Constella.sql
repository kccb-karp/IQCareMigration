...
--0                                                           
 ...
 From mst_User As U    
 Left Outer Join mst_Employee As E On U.UserId = E.UserID    
...
--3                                 
 ...
 Select    
   a.FacilityID,    
   b.ModuleID,    
   'Comprehensive Care Clinic' As DisplayName,    
   1 CanEnroll,    
   'CCC' As ModuleName,    
   1 As ModuleFlag,    
   M.PharmacyFlag,    
   ...
   a.ExpPwdDays    
  From mst_Facility a    
   Inner Join lnk_FacilityModule b On a.FacilityID = b.FacilityID  And a.FacilityID = @LocationId         
   and  b.ModuleID=203    
  Inner Join mst_module M On M.ModuleID=b.ModuleID and M.ModuleID=203     
  --and M.Status=2                               
              union    
      Select    
   a.FacilityID,    
