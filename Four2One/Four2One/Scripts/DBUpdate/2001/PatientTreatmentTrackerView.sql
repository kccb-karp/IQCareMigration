 IF EXISTS(Select name from sys.views where name = 'PatientTreatmentTrackerView')
 DROP VIEW PatientTreatmentTrackerView
 GO
...
INNER JOIN ord_PatientPharmacyOrder c ON a.PatientMasterVisitId = c.PatientMasterVisitId  
 ...
 INNER JOIN PatientMasterVisit h ON c.PatientMasterVisitId = h.Id